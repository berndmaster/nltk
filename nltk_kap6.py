...
#     #checkt, welche suffixe ein wort enthält (z.B. 'endswith(nt)': False) und ordnet boolean zu
#     features = {}
...
# def pos_features(sentence, i): #tagging basiert auf suffixen und vorangehendem wort
...
#         # ein listeneintrag mit suffix 1,2,3 und vorangehenden wort erstellt
